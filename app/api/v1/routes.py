...
from app.api.v1.endpoints.delivery_centers import router as delivery_centers_router
# from app.api.v1.endpoints.users_access_control import router as users_access_control_router  # TODO: Missing models (Location, OrgNode)
...
router.include_router(router=partners_router)
router.include_router(router=delivery_centers_router)
# router.include_router(router=users_access_control_router)  # TODO: Missing models (Location, OrgNode)