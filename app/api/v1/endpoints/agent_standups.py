...
@router.get("/daily-report", dependencies=[Depends(require_permission("admin.view"))])
...
@router.get("/scrum-of-scrums", dependencies=[Depends(require_permission("admin.view"))])
...
@router.get("/weekly-feedback", dependencies=[Depends(require_permission("admin.view"))])
