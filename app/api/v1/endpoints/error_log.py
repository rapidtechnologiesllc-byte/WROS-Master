...
Error Log Viewer UI. Gated to get_current_hr_or_admin -- no dedicated
...
@router.get("", response_model=ErrorLogListResponse, dependencies=[Depends(get_current_hr_or_admin)])
def list_errors(
