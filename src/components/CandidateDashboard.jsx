import { User, FileText, CheckCircle, Bell } from "lucide-react";
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-[#1e293b] text-gray-200 p-6 shadow-xl flex flex-col">
        ...
        <nav className="space-y-3">
          <button className="w-full text-left text-lg hover:bg-[#334155] py-2 px-3 rounded-lg transition flex items-center gap-2">
