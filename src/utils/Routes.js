export const ROUTES = {
  ...
  ADMIN_SETTINGS_ORGANIZATION_BUSINESS_UNITS: "/admin/settings/organization/business-units",
  ADMIN_SETTINGS_ORGANIZATION_DELIVERY_CENTERS: "/admin/settings/organization/delivery-centers",
  ADMIN_SETTINGS_ORGANIZATION_HIERARCHY: "/admin/settings/organization/hierarchy",
  ADMIN_SETTINGS_AI_THRESHOLDS: "/admin/settings/ai-thresholds",
  ADMIN_SETTINGS_SLA: "/admin/settings/sla",
  ADMIN_SETTINGS_CHANNELS: "/admin/settings/channels",
  ADMIN_SETTINGS_LOCALE: "/admin/settings/locale",
