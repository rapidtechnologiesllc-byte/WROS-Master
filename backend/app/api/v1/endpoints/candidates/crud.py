...
def get_all_candidates(
    ...
    Optimized: Basic candidate data only (avoid N+1 query timeout)
    """
    ...
    try:
        ...
        for candidate in candidates:
            ...
            # Get candidate status (single query - candidate_status has FK to candidate)
            ...
            candidate_response = {
                ...
                "pipeline_status": candidate_status.piplineStatus if candidate_status else None
            }
