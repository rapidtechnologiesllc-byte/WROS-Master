...
class FileUpload(Base):
    ...
    file_category = Column(String(512), nullable=False, default="GENERIC", server_default="GENERIC")

    original_filename = Column(String(512), nullable=False)
    unique_filename = Column(String(512), nullable=False)
    ...
    uploaded_by = Column(String(512), ForeignKey("users.UserID", ondelete="NO ACTION"), nullable=True)
