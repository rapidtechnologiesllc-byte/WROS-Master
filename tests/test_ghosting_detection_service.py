...
def db_session():
    ...
    Base.metadata.create_all(engine, tables=[
        ...
        CandidateGhostingStatus.__table__, CandidateNoResponseLog.__table__, FollowUpSchedule.__table__,
        CandidateAIAssignment.__table__, Notification.__table__, ConsentRecord.__table__,
    ])
